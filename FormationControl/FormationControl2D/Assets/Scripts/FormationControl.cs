...
public class FormationControl
{
    ...
    } // Uzaklıklardan Agırlık hesaplama func
    ...
    } // Drone Target Weight listesinden ve Stack listeden hesaplananlar cıkarılıyor
    ...
    int MinPos(List<float> _WeightList)
    {
        ...
        return minpos;
    } // herbir agırlıgın minimumunu donduren func
    List<float> CalcDistance(List<GameObject> Target, GameObject _Drone)
    {
        ...
        return weight;
    } //Drone ile Target arasındaki Uzaklıgı hesaplayan func
    ...
    string DTtoT(List<DTList> _list)// Debug Ekrani için 
    {
